...
var Hexabase = /** @class */ (function () {
     ...
     */
    Hexabase.initializeApp = function (userReq) {
        return __awaiter(this, void 0, void 0, function () {
            var respToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.auth.loginAsync(userReq)];
                    case 1:
                        respToken = _a.sent();
                        sessionStorage_1.HxbSessionStorage.Write('token', respToken.token);
                        console.log("users token: " + sessionStorage_1.HxbSessionStorage.Read('token') + " from sessionStorage");
                        return [2 /*return*/];
                }
            });
        });
    };
    Hexabase.auth = new auth_1.default();
    return Hexabase;
}());
